...
function typeLabel(type = '') { return ({ DISPUTE:'账单争议', DEVICE_OFFLINE:'设备离线', UPLOAD_STUCK:'录像滞留', SESSION_STALE:'会话超时', LOW_STOCK:'库存不足', RECONCILIATION_MISMATCH:'对账差异' } as Record<string,string>)[type] || type; }
...
.quick-label { color: #64748b; font-size: 13px; }
.quick-value { font-size: 28px; font-weight: 700; margin-top: 8px; }
.quick-value.warn { color: #d97706; }
</style>

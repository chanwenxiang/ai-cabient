...
public class AlipayPayClient {
    ...
    public AlipayPrepayResult createWapPay(String outTradeNo, int amountCents, String subject) {
        ...
        String payUrl = openApiClient.buildPagePayUrl("alipay.trade.wap.pay", biz);
        return new AlipayPrepayResult(null, payUrl);
    }
    ...
    public record AlipayPrepayResult(String tradeNo, String payUrl) {}
}

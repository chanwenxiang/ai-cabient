...
public class DemoDataService {
    ...
    private void ensureDevice() {
        if (deviceInfoRepository.existsById(DEMO_DEVICE_ID)) {
            return;
        }
    ...
    private static final List<DemoSkuSeed> DEMO_SKUS = List.of(
            new DemoSkuSeed("SKU-DEMO-001", "可口可乐 330ml", 350, 330, 190,
                    "https://placehold.co/200x200/1677ff/ffffff/png?text=Cola", "经典可乐", "饮料", "6901028300018", 270, 7, 0),
            new DemoSkuSeed("SKU-SODA-001", "雪碧 500ml", 400, 500, 220,
                    "https://placehold.co/200x200/52c41a/ffffff/png?text=Sprite", "柠檬味汽水", "饮料", "6901028300019", 270, 7, 0),
            new DemoSkuSeed("SKU-WATER-001", "矿泉水 550ml", 200, 550, 110,
                    "https://placehold.co/200x200/13c2c2/ffffff/png?text=Water", "饮用天然水", "饮料", "6901028300021", 365, 14, 0),
            new DemoSkuSeed("SKU-SNACK-001", "原味薯片 70g", 650, 70, 360,
                    "https://placehold.co/200x200/faad14/ffffff/png?text=Chips", "休闲零食", "零食", "6901028300022", 180, 7, 0),
            new DemoSkuSeed("SKU-MILK-001", "纯牛奶 250ml", 450, 250, 250,
                    "https://placehold.co/200x200/722ed1/ffffff/png?text=Milk", "常温灭菌乳", "乳品", "6901028300023", 180, 5, 1),
            new DemoSkuSeed("SKU-NOODLE-001", "红烧牛肉面", 520, 120, 290,
                    "https://placehold.co/200x200/fa541c/ffffff/png?text=Noodle", "方便食品", "方便食品", "6901028300024", 270, 7, 0)
    );

...
const BASE_NAV: NavItem[] = [
  ...
  { path: '/fund-bills', title: '资金账单', group: '运营', section: '财务商户', perm: 'ops:fund:list', keywords: ['资金', '账单', '账务', 'ledger'] },
  ...
  { path: '/device-ops', title: '设备运维', group: '业务', section: '设备与商品', perm: 'ops:device-ops:list', keywords: ['运维', '离线', '锁机', 'device-ops'] },
  ...
  { path: '/ota', title: '固件版本', group: '运营', section: '履约仓储', perm: 'ops:ota:list', keywords: ['ota', '固件', '升级', '版本'] },
  { path: '/sla', title: '服务时限监控', group: '运营', section: '履约仓储', perm: 'ops:sla', keywords: ['sla', '服务时限', '开门成功率', '识别耗时', '在线率'] },
  ...
  { path: '/phone-verify', title: '手机验证', group: '运营', section: '增长风控', perm: 'ops:phone-verify:list', keywords: ['手机验证', '验证流水'] },
  { path: '/commercial-hub', title: '商业化中心', group: '运营', section: '财务商户', perm: 'ops:commercial-hub:list', keywords: ['进件', '储值', '算力'] },

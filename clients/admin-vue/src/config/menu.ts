...
const BASE_NAV: NavItem[] = [
  ...
  { path: '/sales-reports', title: '销售报表', group: '概览', perm: 'ops:sales-report:list', keywords: ['销售', '商品报表', '货柜报表', '商户报表'] },
  { path: '/stock-health', title: '库存健康', group: '概览', perm: 'ops:stock-health:list', keywords: ['缺货', '断货', '临期', '库存健康', 'stock'] },

  { path: '/orders', title: '订单管理', group: '交易履约', perm: 'ops:order:list', keywords: ['order'] },
  { path: '/sessions', title: '开门记录', group: '交易履约', perm: 'ops:session:list', keywords: ['会话', 'session'] },
  { path: '/disputes', title: '争议审核', group: '交易履约', perm: 'ops:dispute', keywords: ['争议', 'dispute'] },
  { path: '/exceptions', title: '异常中心', group: '交易履约', perm: 'ops:exception:list', keywords: ['异常', '超时', 'exception'] },
  ...
  { path: '/replenishment', title: '补货调度', group: '履约仓储', perm: 'ops:replenishment:list', keywords: ['补货', '要货', '开门', '路线'] },
  { path: '/warehouse', title: '仓库', group: '履约仓储', perm: 'ops:warehouse:list', keywords: ['库存', '出库'] },
  { path: '/ota', title: '固件版本', group: '履约仓储', perm: 'ops:ota:list', keywords: ['ota', '固件', '升级', '版本'] },
  { path: '/sla', title: '服务时限监控', group: '履约仓储', perm: 'ops:sla', keywords: ['sla', '服务时限', '开门成功率', '识别耗时', '在线率'] },

  { path: '/fund-bills', title: '资金账单', group: '财务商户', perm: 'ops:fund:list', keywords: ['资金', '账单', '账务', 'ledger'] },
  { path: '/merchants', title: '商户与分账', group: '财务商户', perm: 'ops:merchant:list', keywords: ['商户', '分账', '开关', '货道'] },
  { path: '/line-managers', title: '线长钱包', group: '财务商户', perm: 'ops:line-manager:list', keywords: ['线长', '提现', '佣金', '钱包'] },
  { path: '/merchant-withdraw', title: '商户提现', group: '财务商户', perm: 'ops:merchant-withdraw:list', keywords: ['商户提现', '钱包', '打款', '结算'] },
  { path: '/reconciliation', title: '对账', group: '财务商户', perm: 'ops:reconciliation:list', keywords: ['对账', 'recon'] },
  { path: '/consistency', title: '数据一致性', group: '财务商户', perm: 'ops:consistency:list', keywords: ['一致性', '巡检', 'consistency', '库存', '金额'] },
  { path: '/recharges', title: '充值管理', group: '财务商户', perm: 'ops:recharge:list', keywords: ['充值', '余额'] },
  { path: '/users', title: '用户余额', group: '财务商户', perm: 'ops:user:list', keywords: ['用户', '余额', '实名', '灰度'] },

  { path: '/phone-verify', title: '手机验证', group: '增长风控', perm: 'ops:phone-verify:list', keywords: ['手机验证', '验证流水'] },
  { path: '/risk', title: '风控', group: '增长风控', perm: 'ops:risk:list', keywords: ['黑名单', '风险'] },
  { path: '/promotions', title: '营销活动', group: '增长风控', perm: 'ops:promotion:list', keywords: ['营销', '活动', 'promotion', '满减', '折扣'] },
  { path: '/coupons', title: '优惠券', group: '增长风控', perm: 'ops:coupon:list', keywords: ['优惠券', 'coupon', '发券'] },
  { path: '/feedback', title: '用户反馈', group: '增长风控', perm: 'ops:feedback', keywords: ['反馈', '投诉', '建议', 'feedback'] },

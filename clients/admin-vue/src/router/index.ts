...
const bizChildren: any[] = [
  ...
  { path: 'fund-bills', name: 'fund-bills', component: () => import('@/views/finance/FundBillView.vue'), meta: { title: '资金账单', group: '财务商户' } },
  ...
  { path: 'sessions', name: 'sessions', component: () => import('@/views/sessions/SessionListView.vue'), meta: { title: '开门记录', group: '交易履约' } },
  { path: 'videos', redirect: '/upload-queue' },
  { path: 'uploads', redirect: '/upload-queue' },
  { path: 'upload-queue', name: 'upload-queue', component: () => import('@/views/upload/UploadQueueView.vue'), meta: { title: '录像上传', group: '设备商品' } },
  { path: 'orders', name: 'orders', component: () => import('@/views/orders/OrderListView.vue'), meta: { title: '订单管理', group: '交易履约' } },
  { path: 'skus', name: 'skus', component: () => import('@/views/skus/SkuListView.vue'), meta: { title: '商品管理', group: '设备商品' } },
  { path: 'sku-vision', name: 'sku-vision', component: () => import('@/views/skus/SkuVisionEnrollView.vue'), meta: { title: '识别入驻', group: '设备商品' } },
  { path: 'disputes', name: 'disputes', component: () => import('@/views/disputes/DisputeListView.vue'), meta: { title: '争议审核', group: '交易履约' } },
  { path: 'exceptions', name: 'exceptions', component: () => import('@/views/exceptions/ExceptionListView.vue'), meta: { title: '异常中心', group: '交易履约' } },
  { path: 'replenishment', name: 'replenishment', component: () => import('@/views/replenishment/ReplenishmentView.vue'), meta: { title: '补货调度', group: '履约仓储' } },
  { path: 'merchants', name: 'merchants', component: () => import('@/views/merchants/MerchantSplitsView.vue'), meta: { title: '商户与分账', group: '财务商户' } },
  { path: 'line-managers', name: 'line-managers', component: () => import('@/views/finance/LineManagerView.vue'), meta: { title: '线长钱包', group: '财务商户' } },
  { path: 'merchant-withdraw', name: 'merchant-withdraw', component: () => import('@/views/finance/MerchantWithdrawView.vue'), meta: { title: '商户提现', group: '财务商户' } },
  { path: 'reconciliation', name: 'reconciliation', component: () => import('@/views/reconciliation/ReconciliationView.vue'), meta: { title: '对账', group: '财务商户' } },
  { path: 'consistency', name: 'consistency', component: () => import('@/views/consistency/ConsistencyView.vue'), meta: { title: '数据一致性', group: '财务商户' } },
  { path: 'warehouse', name: 'warehouse', component: () => import('@/views/warehouse/WarehouseView.vue'), meta: { title: '仓库', group: '履约仓储' } },
  { path: 'recharges', name: 'recharges', component: () => import('@/views/recharges/RechargeListView.vue'), meta: { title: '充值管理', group: '财务商户' } },
  { path: 'users', name: 'users', component: () => import('@/views/users/UserListView.vue'), meta: { title: '用户余额', group: '财务商户' } },
  { path: 'phone-verify', name: 'phone-verify', component: () => import('@/views/users/PhoneVerifyView.vue'), meta: { title: '手机验证', group: '增长风控' } },
  { path: 'vision-mappings', name: 'vision-mappings', component: () => import('@/views/vision/VisionMappingView.vue'), meta: { title: '识别映射', group: '设备商品' } },
  { path: 'ota', name: 'ota', component: () => import('@/views/ota/OtaView.vue'), meta: { title: '固件版本', group: '履约仓储' } },
  { path: 'sla', name: 'sla', component: () => import('@/views/sla/SlaView.vue'), meta: { title: '服务时限监控', group: '履约仓储' } },
  { path: 'risk', name: 'risk', component: () => import('@/views/risk/RiskView.vue'), meta: { title: '风控', group: '增长风控' } },
  ...
  { path: 'promotions', name: 'promotions', component: () => import('@/views/promotions/PromotionsView.vue'), meta: { title: '营销活动', group: '增长风控' } },
  { path: 'coupons', name: 'coupons', component: () => import('@/views/promotions/CouponsView.vue'), meta: { title: '优惠券', group: '增长风控' } },
  { path: 'feedback', name: 'feedback', component: () => import('@/views/feedback/FeedbackView.vue'), meta: { title: '用户反馈', group: '增长风控' } },
...
const router = createRouter({
  ...
  routes: [
    { path: '/login', name: 'login', component: () => import('@/views/LoginView.vue'), meta: { public: true } },
    {
      ...
      meta: { title: '运营大屏', fullscreen: true }
    },
    {
      path: '/',

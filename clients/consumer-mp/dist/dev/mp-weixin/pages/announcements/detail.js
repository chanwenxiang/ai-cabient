...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent({
  ...
  setup(__props) {
    ...
    async function load() {
      ...
      error.value = "";
      try {
        item.value = await utils_consumerApi.consumerApi.getAnnouncement(announceId);
      } catch (e) {
        item.value = null;
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-4d11c301"], ["__file", "C:/Users/cwx/OneDrive/Desktop/demo/ai-cabinet/clients/consumer-mp/src/pages/announcements/detail.vue"]]);

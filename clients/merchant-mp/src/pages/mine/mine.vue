  ...
  <view>
    ...
    <view class="menu-list">
      ...
      <view class="menu-cell" @click="goSettlements">
        <text class="menu-icon">💰</text>
        <view class="menu-text"><text class="menu-title">结算对账</text><text class="menu-desc">查看营收明细和下载对账单</text></view>
        <text class="menu-arrow">›</text>
      </view>
      <view class="menu-cell" @click="goDisputes">
        <text class="menu-icon">⚖️</text>
        <view class="menu-text"><text class="menu-title">争议处理</text><text class="menu-desc">购物争议申诉与回复</text></view>
        <text class="menu-arrow">›</text>
      </view>
      <view class="menu-cell" @click="goCoupons">
        <text class="menu-icon">🎫</text>
        <view class="menu-text"><text class="menu-title">优惠券管理</text><text class="menu-desc">查看平台优惠券活动</text></view>
        <text class="menu-arrow">›</text>
      </view>

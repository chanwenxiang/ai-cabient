...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent({
  ...
  setup(__props) {
    ...
    function withdrawStatus(status) {
      return common_vendor.displayLabel("merchant_withdraw_status", status, "未知状态");
    }
    ...
    async function load() {
      ...
      loadError.value = "";
      try {
        overview.value = await utils_merchantApi.merchantApi.wallet();
      } catch (e) {
    ...
    async function submitWithdraw() {
      ...
      try {
        await utils_merchantApi.merchantApi.walletWithdraw({
    ...
    return (_ctx, _cache) => {
      return common_vendor.e({
        ...
        g: common_vendor.t(common_vendor.unref(common_vendor.emptyDisplay)(overview.value.merchantName, "text")),
        h: common_vendor.t(common_vendor.unref(common_vendor.emptyDisplay)(overview.value.merchantId, "text")),
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-22d1a5ac"], ["__file", "C:/Users/cwx/OneDrive/Desktop/demo/ai-cabinet/clients/merchant-mp/src/pages/wallet/wallet.vue"]]);

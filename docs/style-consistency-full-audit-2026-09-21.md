# 三端样式全量逐页审计（2026-09-21）

> 生成方式：`node scripts/style-full-audit.mjs`（全量逐页扫描，无抽样，可重复执行）
> 机器可读数据：`style-consistency-full-audit-2026-09-21.json`（本目录）
...
| 页面数 | 70 | 24 | 23 |
| 组件/布局文件数 | 18 | 9 | 14 |
| 裸 hex 色（待治理） | 162 | 48 | 25 |
| var() 兜底 hex | 79 | 538 | 413 |
| 字面圆角（非 token） | 104 | 48 | 45 |
| 内联 style 带色值 | 9 | 0 | 0 |
| 原生 <button> | 90 | 15 | 25 |
| app-button 使用 | 0 | 59 | 37 |
| 手写空状态页数 | 7 | 13 | 8 |
| empty-state 使用 | 0 | 11 | 15 |
| error-state 使用 | 0 | 0 | 14 |
| script 图表裸色（admin 专属） | 24 | 0 | 0 |
...
| views/dashboard/BigScreenView.vue | 6 | 12 | 8 | · | · | ✗ | · | · |
...
| pages/index/index.vue | 4 | 91 | 12 | · | 8 | 1 | · | ⚠ | --text-secondary |
...
| pages/mine/mine.vue | 2 | 19 | 4 | · | · | · | · | · | · |
| pages/nearby/nearby.vue | 9 | 18 | 5 | · | 2 | 1 | · | · | · |
...
| pages/recharge/recharge.vue | 3 | 21 | · | · | · | 5 | 1 | ⚠ | · |
...
| 页面 | 裸hex | 兜底 | 字面圆角 | 内联色 | 原生btn | app-button | empty-state | 手写空态 | 未定义变量 |
|---|---|---|---|---|---|---|---|---|---|
| pages/alerts/alerts.vue | · | 20 | · | · | 1 | 1 | 1 | · | · |
| pages/announcements/announcements.vue | · | 4 | · | · | · | · | 1 | · | · |
| pages/announcements/detail.vue | · | 5 | · | · | · | · | · | · | · |
| pages/business/business.vue | · | 34 | 6 | · | 1 | 1 | · | ⚠ | --text-secondary,--accent-blue |
| pages/device-detail/device-detail.vue | · | 15 | 3 | · | · | 5 | · | · | · |
| pages/devices/devices.vue | · | 21 | 1 | · | 1 | 2 | 1 | · | · |
| pages/disputes/disputes.vue | · | 22 | · | · | · | 9 | 1 | · | · |
| pages/home/home.vue | · | 38 | 2 | · | · | 4 | 1 | ⚠ | · |
| pages/line-wallet/line-wallet.vue | · | · | · | · | · | · | · | · | · |
| pages/login/login.vue | 3 | 9 | 2 | · | · | 1 | · | · | · |
| pages/messages/messages.vue | · | 8 | · | · | · | · | · | ⚠ | · |
| pages/mine/mine.vue | 2 | 23 | 3 | · | 4 | · | · | · | · |
| pages/order-detail/order-detail.vue | 1 | 14 | · | · | · | 3 | · | · | · |
| pages/orders/orders.vue | 2 | 19 | 1 | · | 1 | · | 1 | · | · |
| pages/policy/privacy.vue | · | 1 | · | · | · | · | · | · | · |
| pages/pricing/pricing.vue | · | 7 | 1 | · | · | · | 1 | · | · |
| pages/replenishment/replenishment.vue | · | 36 | 2 | · | 4 | 2 | 1 | ⚠ | · |
| pages/request/request.vue | 2 | 22 | · | · | · | 1 | · | ⚠ | · |
| pages/settlements/settlements.vue | · | 12 | · | · | · | 1 | 2 | · | · |
...
|---|---|---|---|---|---|
| admin-vue | components/ChartBox.vue | 8 | 3 | · | · |
...
| consumer-mp | App.vue | 12 | 4 | · | · |
| consumer-mp | components/app-button.vue | 2 | · | 1 | · |
| consumer-mp | components/device-ad-banner.vue | 1 | · | · | · |
| consumer-mp | components/empty-state.vue | · | 7 | · | · |
| consumer-mp | components/error-state.vue | · | 1 | · | · |
...
| merchant-mp | components/empty-state.vue | · | 7 | · | · |
| merchant-mp | components/error-state.vue | · | 1 | · | · |
| merchant-mp | components/ReplenishActionDock.vue | · | 1 | · | · |
| merchant-mp | components/ReplenishCabinetCard.vue | · | 1 | · | · |
| merchant-mp | components/ReplenishLinesSection.vue | · | 2 | 1 | · |
| merchant-mp | components/ReplenishStepBar.vue | 1 | 1 | · | · |

## 六、页面注册完整性（防漏页）

- **admin-vue**：实际页面文件 70 个；注册/路由引用 70 个；缺失文件 0；未注册孤儿 0
- **consumer-mp**：实际页面文件 24 个；注册/路由引用 24 个；缺失文件 0；未注册孤儿 0
- **merchant-mp**：实际页面文件 23 个；注册/路由引用 23 个；缺失文件 0；未注册孤儿 0

**consumer-mp globalStyle**：{"navigationBarTextStyle":"white","navigationBarBackgroundColor":"#134e4a","backgroundColor":"#ffffff","backgroundColorTop":"#134e4a","backgroundColorBottom":"#ffffff","backgroundTextStyle":"dark"}；tabBar：{"color":"#86a89a","selectedColor":"#0f766e","backgroundColor":"#ffffff"}
...
|---|---|---|
| app-button.vue | ⚠ 差异 4 行 | ⚠ 差异 4 行 |
| app-nav-bar.vue | ⚠ 差异 5 行 | ⚠ 差异 7 行 |
| empty-state.vue | 一致 | 一致 |
| error-state.vue | ⚠ 差异 2 行 | ⚠ 差异 2 行 |
...
- merchant-mp · pages/business/business.vue：--text-secondary、--accent-blue

## 九、模板引用但找不到定义的类（需人工确认是否死类/动态拼接）

- admin-vue · views/analytics/AnalyticsView.vue：analytics-page
- admin-vue · views/devices/DeviceDetailView.vue：form-hint、policy-form、repair-mini-table
...
- admin-vue · components/ChartBox.vue：chart-error、chart-empty
...
5. 裸 hex 按密度治理（≥3 处的页面优先）：
   - consumer-mp：pages/nearby/nearby.vue(9)、pages/member/index.vue(7)、pages/index/index.vue(4)、pages/recharge/recharge.vue(3)
   - merchant-mp：pages/login/login.vue(3)
6. 字面圆角接 token（≥3 处的页面优先）：
   - consumer-mp：pages/index/index.vue(12)、pages/nearby/nearby.vue(5)、pages/mine/mine.vue(4)
   - merchant-mp：pages/business/business.vue(6)、pages/video/video.vue(4)、pages/device-detail/device-detail.vue(3)、pages/mine/mine.vue(3)

**P2 · 管理后台收尾**

1. ECharts 迁移（替代手写 SVG）：views/analytics/AnalyticsView.vue(script裸色16)、views/devices/DeviceMapView.vue(script裸色2)、views/finance/FinanceView.vue(script裸色3)
...
3. 字面圆角接 --radius-*：views/dashboard/BigScreenView.vue(8)、views/devices/DeviceMapView.vue(7)、views/devices/DeviceDetailView.vue(6)、views/LoginView.vue(6)、views/replenishment/ReplenishmentView.vue(5)、views/system/ApprovalConfigView.vue(5)、views/analytics/FootfallView.vue(4)、views/skus/SkuVisionEnrollView.vue(4)、views/disputes/DisputeListView.vue(3)、views/exceptions/ExceptionListView.vue(3)、views/print/PrintView.vue(3)、views/system/OrgSitesView.vue(3)（其余 1-2 处的随页面顺手改）
4. 裸 hex 收敛（≥5 处优先）：views/analytics/AnalyticsView.vue(26)、views/LoginView.vue(23)、views/print/PrintView.vue(19)、views/analytics/FootfallView.vue(12)、views/finance/FinanceView.vue(11)、views/devices/DeviceMapView.vue(9)、views/growth/UserAnalysisView.vue(7)、views/dashboard/BigScreenView.vue(6)

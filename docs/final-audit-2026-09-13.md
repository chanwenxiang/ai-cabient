...
- [x] S-P1-2 Session 拆分（`SessionExpireService` / `SessionOpenService` / `SessionRestockService`；SessionService 仍含关门/结算编排）
- [x] A-P2-002 WarehouseView 拆分（采购 + 盘点/货位 + 出库/调拨写流；页约 4.3k 行，列表壳可继续瘦）

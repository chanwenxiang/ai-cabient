...
- [ ] M-P1-3 replenishment.vue 拆分（已抽 ConfirmDialog / StepBar / DetailSheet / CabinetCard / EvidenceSection / LinesSection / ActionDock；页级状态与 API 编排仍在页内）
- [ ] S-P1-1 SettlementService 拆分（已抽 VisionAsync / PartialRefundMath / WaiveRefund / ConfirmDispute；主 settle/finalizeOrder 仍待续）

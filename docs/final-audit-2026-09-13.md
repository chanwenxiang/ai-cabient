...
- [ ] M-P1-3 replenishment.vue 拆分（已抽子组件 + `useAppConfirmDialog` / `useReplenishmentDoorState`；列表/API 编排仍在页内）
- [ ] S-P1-1 SettlementService 拆分（已抽 VisionAsync / PartialRefundMath / WaiveRefund / ConfirmDispute / OrderFinalize；识别决策管线仍待续）

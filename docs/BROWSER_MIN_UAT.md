...
# 附录 A：执行报告（原 BROWSER_MIN_UAT_REPORT.md）
...
截图：`archive/uat-screenshots/2026-07-12/` · 复测：`archive/uat-screenshots/2026-08-04/`
...
详细证据：`archive/uat-screenshots/2026-08-04/L-08-results.json` 等。
...
复测原始结果：`archive/uat-screenshots/2026-08-04/defect-retest-2026-08-04.json`
...
- L-08：`archive/uat-screenshots/2026-08-04/L-08-*.png`
- L-09：`archive/uat-screenshots/2026-08-04/L-09-*.png`
- L-10：`archive/uat-screenshots/2026-08-04/L-10-*.png`
- UI-01：`archive/uat-screenshots/2026-08-04/UI-01-retest-admin-devices.png`、`UI-01-retest-merchant-devices.png`、`UI-01-retest-consumer-home.png`
- 缺陷汇总 JSON：`archive/uat-screenshots/2026-08-04/defect-retest-2026-08-04.json`

---

# 附录 B：执行跟踪表（原 BROWSER_MIN_UAT_TRACKING.md）

 ...
 * - 统计：其余 align="center" 债务（状态/操作等可保留；全量清零走 Wave C）
 *
 * 用法：node scripts/check-admin-table-align.mjs
 * STRICT=1 时，任意「无 col-action/col-money/col-status」的 align=center 也失败（渐进收紧用）
 */
...
if (conflicts.length > 0 || (STRICT && bareCenter.length > 0)) {
  process.exit(1);
}

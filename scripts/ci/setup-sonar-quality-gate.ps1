...
$conds = @(
  ...
  @{ gateName = "AI Cabinet"; metric = "new_coverage"; op = "LT"; error = "40" }
)
...
Write-Host "Quality gate ready: AI Cabinet (vuln=0, blocker=0, hotspots=100%, dup<=3%, coverage>=40%)" -ForegroundColor Green
